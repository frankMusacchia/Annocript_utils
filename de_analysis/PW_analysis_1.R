#ENRICHMENT OF PATHWAYS GIVEN A LIST OF TRANSCRIPTS
...
# The minimum number of transcripts associated to a GO class to take it into consideration for the analysis
...
#If it is "sign", the minimum number of transcripts is from the significant table  while if it is
#"ann" it is from the annocript output table
...
if(col.signifTable==0) {
  sel = unique(rownames(d)) #Removing if there are repeated ids
